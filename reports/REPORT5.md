...
![ClearML login](../screenshots/clearml_login.jpg)
...
![Projects](../screenshots/clearml_projects.jpg)
...
![ClearML single](../screenshots/clearml_single1.jpg)
![ClearML single](../screenshots/clearml_single2.jpg)
...
![ClearML single](../screenshots/clearml_cli_grid.jpg)
![ClearML single](../screenshots/clearml_metrics.jpg)
![ClearML single](../screenshots/clearml_tasks.jpg)
![ClearML single](../screenshots/clearml_models.jpg)

```bash
# Сравнение экспериментов
poetry run python scripts/compare_experiments.py
```
![ClearML single](../screenshots/clearml_models_compare.jpg)
![ClearML single](../screenshots/clearml_report.jpg)
