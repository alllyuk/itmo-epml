...
```
![Copier](../assets/images/copier_querstions.jpg)
![Copier](../assets/images/copier_work.jpg)
...
pre-commit install
```
![Shell](../assets/images/poetry_shell.jpg)

**Запуск:**
```bash
pre-commit run --all-files
```
![Shell](../assets/images/hooks.jpg)
...
poetry run pytest
```
![Poetry](../assets/images/pytest.jpg)
